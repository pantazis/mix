                                ...
                                <tbody>
                                    <?php $i = 0; foreach ($ssldata2 as $key => $value)  { ?>
                                       ...
                                       <td class="column1"> <span class="cat">Κατάσταση:</span>
                                          <span class="waves-effect waves-light btn"> <?=$value['state']['name']?> </span>                                       </td>
                                       ...
                                       <td class="column1"> <span class="cat">Email:</span>
                                           ...
                                           <a href=""class="waves-effect waves-light btn">Έκδοση</a>
                                           <?php $i++;?>
                                           <?php  }else{ ?>
                                           <a href=""class="waves-effect waves-light btn">Ανανέωση</a>
                                           <?php  } ?>
                                            </td>

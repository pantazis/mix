...
/***/ "./resources/assets/js/_libraries/materialize.min.js":
/*!***********************************************************!*\
  !*** ./resources/assets/js/_libraries/materialize.min.js ***!
  \***********************************************************/
/*! no static exports found */
  ...
  var Tabs = function (_Component6) {
    ...
    _createClass(Tabs, [{
      ...
      value: function _handleTabClick(e) {
        ...
        if (tab.length == 0) {
          var activeEL = $(".owl-dot.active");
          var activeIndex = $(".owl-dot").index(activeEL);
          var tab = $($('li.tab')[activeIndex]).closest('li.tab');
          var tabLink = $(tab).find('a');
        }

        var tabindex = $(tab).parent().find("li").index(tab); // Handle click on tab link only
        ...
        if (this.options.swipeable) {
          ...
          if (this.$content.length || $('.owl-carousel').length) {
            var nexttab = $('.owl-dots .owl-dot')[tabindex];
    ...
    _createClass(Toast, [{
      ...
      value: function dismiss() {
        ...
        anim({
          targets: this.el,
          opacity: 0,
          marginTop: -$(this.el).height(),
          duration: this.options.outDuration,
          easing: 'easeOutExpo',
          complete: function complete() {
            // Call the optional callback
            console.log(_this30.options.completeCallback);
      ...
      value: function _createContainer() {
        ...
        M.toast._onDragEnd2 = Toast._onDragEnd2; // Add event handler
      ...
      value: function _onDragMove(e) {
        window.M.dragged = !!Toast._draggedToast;
      ...
      key: "_onDragEnd2",
      value: function _onDragEnd2(el) {
        event.stopPropagation();
        var toast = Toast._draggedToast;
        var activationDistance = toast.el.offsetWidth * toast.options.activationPercent;
        var animetime = 300;
        $(toast.el).css({
          "transform": "translateX(-" + activationDistance + "px)",
          "opacity": "0",
          "transition": "all " + animetime / 1000 + "s"
        });
        $(toast.el)[0].addEventListener('transitionend', function () {
          $(toast.el).css("margin-top", "-" + $(toast.el).height() + "px");
          setTimeout(function () {
            toast.wasSwiped = false;
            $(toast.el).remove();
          }, animetime);
        }); //
        //opacity: 0;
...
/***/ 1:
/*!*****************************************************************!*\
  !*** multi ./resources/assets/js/_libraries/materialize.min.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\wamp64\www\mix\resources\assets\js\_libraries\materialize.min.js */"./resources/assets/js/_libraries/materialize.min.js");

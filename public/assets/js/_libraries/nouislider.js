...
/***/ "./resources/assets/js/_libraries/nouislider.js":
/*!******************************************************!*\
  !*** ./resources/assets/js/_libraries/nouislider.js ***!
  \******************************************************/
...
(function () {
  ...
  function x(b) {
    ...
    for (f = 0; f < h.length; f += 1) {
      c = h[f], d = b[c], void 0 === d ? e[c] = "negative" !== c || e.negativeBefore ? "mark" === c && "." !== e.thousand ? "." : !1 : "-" : "decimals" === c ? 0 < d && 8 > d && (e[c] = d) : "encoder" === c || "decoder" === c || "edit" === c || "undo" === c ? "function" === typeof d && (e[c] = d) : "string" === typeof d && (e[c] = d);
    }
  ...
  function t(b) {
    ...
    "object" === _typeof(b) && (b = x(b), this.to = function (f) {
      return u(b, v, f);
...
(function (factory) {
  ...
  'use strict'; // Creates a node, adds it to target, returns the new node.
  ...
  function closure(target, options, originalOptions) {
    var actions = getActions(); // All variables local to 'closure' are prefixed with 'scope_'
    ...
    var scope_Values = [];
    var scope_Events = {};
    var scope_Self; // Append a origin to the base
    ...
    function generateSpread(density, mode, group) {
      ...
      var indexes = {},
          ...
          ignoreFirst = false,
          ignoreLast = false,
          prevPct = 0; // Create a copy of the group, sort it and filter away all duplicates.
    ...
    function attachEvent(events, element, callback, data) {
      ...
      var method = function method(e) {
        ...
        e = fixEvent(e, data.pageOffset); // Handle reject of multitouch
    ...
    function moveHandles(upward, proposal, locations, handleNumbers) {
      ...
      if (handleNumbers.length > 1) {
        handleNumbers.forEach(function (handleNumber, o) {
          var to = checkHandlePosition(proposals, handleNumber, proposals[handleNumber] + proposal, b[o], f[o]); // Stop if one of the handles can't move.
    ...
    function eventStart(event, data) {
      if (data.handleNumbers.length === 1) {
        var handle = scope_Handles[data.handleNumbers[0]]; // Ignore 'disabled' handles
      ...
      document.documentElement.noUiListeners = moveEvent.concat(endEvent, outEvent); // Text selection isn't an issue on touch devices,
    ...
    function updateOptions(optionsToUpdate, fireSetEvent) {
      ...
      options.padding = newOptions.padding; // Invalidate the current positioning so valueSet forces an update.
...
/***/ 2:
/*!************************************************************!*\
  !*** multi ./resources/assets/js/_libraries/nouislider.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\wamp64\www\mix\resources\assets\js\_libraries\nouislider.js */"./resources/assets/js/_libraries/nouislider.js");
